...
from .constants import GuacClientLogLevel, GUAC_CLIENT_ID_PREFIX, GUACD_SOCKET_DEFAULT_DIR, GUACD_ROUTER_SOCKET_PATH
...
class Router:
    ...
    async def zmq_listener(self):
        user_ipc_addr = await self.router_sock.recv_string()
