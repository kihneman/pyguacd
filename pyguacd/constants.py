...
GUACD_SOCKET_DEFAULT_DIR = join(dirname(__file__), 'ipc')
...
GUACD_ZMQ_PROXY_CLIENT_SOCKET_FILENAME = 'client-proxy'
GUACD_ZMQ_PROXY_CLIENT_SOCKET_PATH = join(GUACD_SOCKET_DIR, GUACD_ZMQ_PROXY_CLIENT_SOCKET_FILENAME)
GUACD_ZMQ_PROXY_USER_SOCKET_FILENAME = 'user-proxy'
GUACD_ZMQ_PROXY_USER_SOCKET_PATH = join(GUACD_SOCKET_DIR, GUACD_ZMQ_PROXY_USER_SOCKET_FILENAME)
GUACD_USER_SOCKET_FILENAME = 'user-'
GUACD_USER_SOCKET_PATH = join(GUACD_SOCKET_DIR, GUACD_USER_SOCKET_FILENAME)

# Other Zmq settings
GUACD_USE_PROXY = True
